...
let permit = ({ activity = null, forItem = null, givenThat = null } = {}) => {
  if (!activity || !forItem || !givenThat) {
    throw new Error('hooch#permit is missing a parameter. This is a fatal error due to security concerns.');
  }
  if (!library[activity]) {
    library[activity] = {};
  }
